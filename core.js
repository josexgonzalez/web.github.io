function showTemporaryAlert(message, callback) {
    ...
    icon.src = 'https://raw.githubusercontent.com/josexgonzalez/web.github.io/refs/heads/index.html/icon.png'; // Cambia 'setting.png' al nombre de tu imagen en el directorio raíz
